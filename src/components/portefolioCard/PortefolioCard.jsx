...
export default function PortefolioCard({ image, title }) {
  return (
    <div className="portefolio-card rounded-xl relative">
      {image}
      <h4 className="absolute h-[101%] w-full flex justify-center items-center rounded-xl bg-[#183966] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap">
